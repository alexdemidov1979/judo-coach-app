  ...
  function techDetailHtml(it){
    ...
    html += `<div class="kg-inline-action"><button type="button" class="btn ghost small kg-open-btn" data-open-knowledge-graph="${it.romaji.replace(/"/g,'&quot;')}">🧠 Карта техники</button></div>`;
    html += `</div>`;
    return html;
  }
